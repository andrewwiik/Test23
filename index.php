...
?>
					<img class="icon" src="<?php echo(SITE_URL); ?>icon/<?php echo($section_assoc['Icon']); ?>">
<?php
					} else {
?>
					<img class="icon" src="<?php echo(SITE_URL); ?>icon/default/unknown.png">
<?php
					}
?>
					<div>
...
?>
    ...
    <script src="<?php echo(SITE_URL); ?>manage/js/jquery-2.1.1.js"></script>
...
?>
				<img class="icon" src="<?php echo(SITE_URL); ?>icon/<?php echo($section_icon); ?>" style="width: 64px; height: 64px; vertical-align: top;" />
<?php
			} else {
?>
				<img class="icon" src="<?php echo(SITE_URL); ?>icon/default/unknown.png" style="width: 64px; height: 64px; vertical-align: top;" />
<?php
			}
?>
				<div id="content">
...
<div class="slick_demo_2" style="width:600px">
