...
?>
				...
				<form class="form settingsform" method="POST" id="settings" action="settings.php?action=set">
            <div class="col-lg-6">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="display: none;">
							...
							<label ><?php _e( 'Language' ); if ( substr( $locale, 0, 2 ) != 'en' ) { ?> Language<?php } ?></label>
...
?>
								...
								<p class="help-block"><?php _e('If you want the system auto detect users browser language to show pages please select "Detect" option.'); if ( substr( $locale, 0, 2 ) != 'en' ) { ?>If you want the system auto detect users browser language to show pages please select "Detect" option.<?php } ?></p>
							</div>

						
						<div class="form-group">
							<label ><?php _e('Rewrite Mod');?></label>

								<select class="form-control" name="rewrite_mod">
<?php
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="javascript:{}" onclick="document.getElementById('settings').submit(); return false;">Save</a>
                                </li>
                            </ul>
                            <a class="close-link">
                                <i class="fa fa-times"></i>
                    ...
                    <div class="ibox-content" style="display: none;">
                        <div class="form-group">
							<label  style="color: red;"><?php _e('Master Switch');?></label>

								<select class="form-control" name="pcindex">
        ...
        <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="display: none;">
						...
						<div class="form-group">
							<label ><?php _e('Show Latest List');?></label>
						...
						<div class="form-group">
							<label ><?php _e('Number of Latest List');?></label>

								<input class="form-control" type="number" name="listnum" max="20" data-validation-max-message="<?php printf(__('Too high: Maximum of \'%s\''), '20'); ?>" value="<?php echo htmlspecialchars(DCRM_SHOW_NUM); ?>"/>
								<p class="help-block"><?php _e('Must be lower than 20.');?></p>

						</div>
						
						<div class="form-group">
							<label ><?php _e('Full List of Sections');?></label>

								<select class="form-control" name="allowfulllist">
						...
						<div class="form-group">
							<label ><?php _ex('Screenshorts', 'Settings');?></label>

								<select class="form-control" name="screenshots">
						...
						<div class="form-group">
							<label ><?php _e('Report Problems');?></label>
						...
						<div class="form-group">
							<label ><?php _e('Limit Number of Report');?></label>

								<input class="form-control" type="number" name="reportlimit" max="10" data-validation-max-message="<?php printf(__('Too high: Maximum of \'%s\''), '10'); ?>" value="<?php echo htmlspecialchars(DCRM_REPORT_LIMIT); ?>"/>
								<p class="help-block"><?php _e('The maximum not more than 10 times.'); ?></p>
							</div>

						
						<div class="form-group">
							<label ><?php _e('Update Logs');?></label>

								<select class="form-control" name="updatelogs">
						...
						<div class="form-group">
							<label ><?php _e('More Information');?></label>
							<div class="controls">
						...
						<div class="form-group" id="multiinfo">
							<label ><?php _e('Detailed Description'); ?></label>

								<select class="form-control" name="multiinfo">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="display: none;">
                        <div class="form-group">
							<label ><?php _ex('Site Name', 'SEO');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="SEO" value="<?php if(defined("AUTOFILL_SEO")){echo(htmlspecialchars(stripslashes(AUTOFILL_SEO)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _ex('Site Address', 'SEO');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="SITE" style="width: 400px;" value="<?php if(defined("AUTOFILL_SITE")){echo(htmlspecialchars(stripslashes(AUTOFILL_SITE)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _ex('Site Keyword', 'SEO');?></label>
							<div class="controls">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php _e('Administrator Informations');?></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-down"></i>
                            </a>
                    ...
                    <div class="ibox-content" style="display: none;">
                        <div class="form-group">
							<label ><?php _ex('Name', 'Administrator');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="MASTER" value="<?php if(defined("AUTOFILL_MASTER")){echo(htmlspecialchars(stripslashes(AUTOFILL_MASTER)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _ex('Full Name', 'Administrator');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="FULLNAME" style="width: 400px;" value="<?php if(defined("AUTOFILL_FULLNAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_FULLNAME)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _ex('Email Address', 'Administrator');?></label>
							<div class="controls">
								<input class="form-control" type="email" name="EMAIL" style="width: 400px;" data-validation-email-message="<?php _e('Not a valid email address'); ?>" value="<?php if(defined("AUTOFILL_EMAIL")){echo(htmlspecialchars(stripslashes(AUTOFILL_EMAIL)));} ?>"/>
							</div>
						</div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php _e('Login Information');?></h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-down"></i>
                            </a>
                    ...
                    <div class="ibox-content" style="display: none;">
                        <div class="form-group">
							<label ><?php _e('Username');?></label>
								...
								<input class="form-control" type="text" required="required" name="username" minlength="4" maxlength="20" data-validation-minlength-message="<?php _e('Username length must be between 4-20 characters!'); ?>" value="<?php echo htmlspecialchars($_SESSION['username']); ?>" data-validation-regex-regex="^[0-9a-zA-Z\_]*$" data-validation-regex-message="<?php _e('Username can only use numbers, letters and underline!'); ?>" />
						...
						<div class="form-group">
							<label ><?php _e('Repeat New Password');?></label>
								...
								<input class="form-control" type="password" name="pass2" id="pass2" data-validation-match-match="pass1" data-validation-match-message="<?php _e('Your password do not match.'); ?>"/>
								<p class="help-block"><?php _e('Type your new password again.');?></p>

						</div>
						
						<div class="form-group">
							<label ><?php _e('The maximum number of attempts');?></label>

								<input class="form-control" type="number" required="required" name="trials" value="<?php echo htmlspecialchars(DCRM_MAXLOGINFAIL); ?>"/>

						</div>
						
						<div class="form-group">
							<label ><?php _e('Login Fail Reset Time');?></label>

								<input class="form-control" type="number" required="required" name="resettime" value="<?php if(defined(DCRM_LOGINFAILRESETTIME)){echo(htmlspecialchars(DCRM_LOGINFAILRESETTIME)/60);}else{echo(10);} ?>"/>
								<p class="help-block"><?php _e('Unit: Minutes');?></p>

						</div>
						
						<div class="form-group">
							<label  style="color: red;"><?php _e( 'Repository URL' ); ?></label>

								<input class="form-control" type="text" required="required" name="url_repo" style="width: 400px;" data-validation-regex-regex="((https?):\/\/)?([a-z]([a-z0-9\-]*[\.。])+([a-z]*)|(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/[a-z0-9_\-\.~]+)*(\/([a-z0-9_\-\.]*)(\?[a-z0-9+_\-\.%=&]*)?)?(#[a-z][a-z0-9_]*)?" data-validation-regex-message="<?php _e('Not a valid website address'); ?>" value="<?php echo htmlspecialchars(base64_decode(DCRM_REPOURL)); ?>"/>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="display: none;">
                       <div class="form-group">
							<label ><?php _e('Alipay Account');?></label>

								<input class="form-control" type="text" name="alipay_account" value="<?php echo(get_option('alipay_account')); ?>"/>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="display: none;">
                        <div class="form-group">
							<label  style="color: red;"><?php _e('PHP Forward');?></label>

								<select class="form-control" name="php_forward">
						...
						<div class="form-group">
							<label ><?php _e('Module Enabled');?></label>

								<select class="form-control" name="module_enabled">
						...
						<div class="form-group">
							<label ><?php _e('HotLink Protection');?></label>
							<div class="controls">
								<select class="form-control" name="directdown">
						...
						<div class="form-group">
							<label  style="color: red;"><?php _e('Max Download Speed');?></label>
							<div class="controls">
								<input class="form-control" type="number" required="required" name="speedlimit" value="<?php echo htmlspecialchars(DCRM_SPEED_LIMIT); ?>"/>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="display: none;">
                        <div class="form-group">
							<label  style="color: red;"><?php _e('Packages File Compression');?></label>
							<div class="controls">
								<select class="form-control" name="listsmethod">
<?php
...
?>
						...
						<div class="form-group">
							<label  style="color: red;"><?php _e('Packages Validation ');?></label>
							<div class="controls">
								<select class="form-control" name="checkmethod">
<?php
...
?>
						...
						<div class="form-group">
							<label  style="color: red;"><?php _e('Downgrade Support');?></label>
							<div class="controls">
								<select class="form-control" name="downgrade">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="display: none;">
                        <div class="form-group">
							<label ><?php _e('Autofill Depiction');?></label>
							<div class="controls">
								<select class="form-control" name="autofill_depiction">
						...
						<div class="form-group">
							<label ><?php _e('Default Identifier of Packages');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="PRE" style="width: 400px;" value="<?php if(defined("AUTOFILL_PRE")){echo(htmlspecialchars(stripslashes(AUTOFILL_PRE)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Default Name of Packages');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="NONAME" style="width: 400px;" value="<?php if(defined("AUTOFILL_NONAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_NONAME)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Default Depiction of Packages');?></label>
							<div class="controls">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="form-group">
							<label ><?php _e('Starting Year of Copyright');?></label>
							<div class="controls">
								<input class="form-control" type="number" name="FOOTER_YEAR" style="width: 65px;" value="<?php if(defined("AUTOFILL_FOOTER_YEAR")){echo(htmlspecialchars(stripslashes(AUTOFILL_FOOTER_YEAR)));} ?>" />
						...
						<div class="form-group">
							<label ><?php _e('Copyright Name');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="FOOTER_NAME" value="<?php if(defined("AUTOFILL_FOOTER_NAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_FOOTER_NAME)));} ?>"/>
						...
						<div class="form-group">
							<label ><?php _e('Footer Code');?></label>
							<div class="controls">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="form-group">
							<label ><?php _e('Duoshuo Social Comments KEY');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="DUOSHUO_KEY" value="<?php if(defined("AUTOFILL_DUOSHUO_KEY")){echo(htmlspecialchars(stripslashes(AUTOFILL_DUOSHUO_KEY)));} ?>"/>
						...
						<div class="form-group">
							<label ><?php _e('QQ Group Name');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="TENCENT_NAME" value="<?php if(defined("AUTOFILL_TENCENT_NAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_TENCENT_NAME)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('QQ Group Number');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="TENCENT" style="width: 400px;" value="<?php if(defined("AUTOFILL_TENCENT")){echo(htmlspecialchars(stripslashes(AUTOFILL_TENCENT)));} ?>"/>
								<p class="help-block"><?php _e('Need the new mobile client.');?></p>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Weibo Name');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="WEIBO_NAME" value="<?php if(defined("AUTOFILL_WEIBO_NAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_WEIBO_NAME)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Weibo Address');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="WEIBO" style="width: 400px;" data-validation-regex-regex="((https?):\/\/)?((weibo\.cn\/))([a-z0-9_\-\.~]+)*(\/([a-z0-9_\-\.]*)(\?[a-z0-9+_\-\.%=&]*)?)?(#[a-z][a-z0-9_]*)?" data-validation-regex-message="<?php printf(__('Not a valid mobile weibo address. Example: %s'), '<code>http://weibo.cn/hintay</code>'); ?>" value="<?php if(defined("AUTOFILL_WEIBO")){echo(htmlspecialchars(stripslashes(AUTOFILL_WEIBO)));} ?>"/>
								<p class="help-block"><?php _e('Please input the mobile version homepage.');?></p>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Twitter Name');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="TWITTER_NAME" value="<?php if(defined("AUTOFILL_TWITTER_NAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_TWITTER_NAME)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Twitter Address');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="TWITTER" style="width: 400px;" data-validation-regex-regex="((https?):\/\/)?((www.)*(twitter.com\/))([a-z0-9_\-\.~]+)*(\/([a-z0-9_\-\.]*)(\?[a-z0-9+_\-\.%=&]*)?)?(#[a-z][a-z0-9_]*)?" data-validation-regex-message="<?php _e('Not a valid website address'); ?>" value="<?php if(defined("AUTOFILL_TWITTER")){echo(htmlspecialchars(stripslashes(AUTOFILL_TWITTER)));} ?>"/>
								<p class="help-block"><?php _e('Need login for visit.');?></p>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Facebook Name');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="FACEBOOK_NAME" value="<?php if(defined("AUTOFILL_FACEBOOK_NAME")){echo(htmlspecialchars(stripslashes(AUTOFILL_FACEBOOK_NAME)));} ?>"/>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Facebook Address');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="FACEBOOK" style="width: 400px;" data-validation-regex-regex="^((https?):\/\/)?((www.)*(facebook.com\/))([a-z0-9_\-\.~]+)*(\/([a-z0-9_\-\.]*)(\?[a-z0-9+_\-\.%=&]*)?)?(#[a-z][a-z0-9_]*)?$" data-validation-regex-message="<?php _e('Not a valid website address'); ?>" value="<?php if(defined("AUTOFILL_FACEBOOK")){echo(htmlspecialchars(stripslashes(AUTOFILL_FACEBOOK)));} ?>"/>
								<p class="help-block"><?php _e('Need login for visit.');?></p>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Paypal Donate Address');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="PAYPAL" style="width: 400px;" data-validation-regex-regex="((https?|ftp|news):\/\/)?([a-z]([a-z0-9\-]*[\.。])+([a-z]{2}|aero|arpa|biz|com|coop|edu|gov|info|int|jobs|mil|museum|name|nato|net|org|pro|travel)|(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/[a-z0-9_\-\.~]+)*(\/([a-z0-9_\-\.]*)(\?[a-z0-9+_\-\.%=&]*)?)?(#[a-z][a-z0-9_]*)?" data-validation-regex-message="<?php _e('Not a valid website address'); ?>" value="<?php if(defined("AUTOFILL_PAYPAL")){echo(htmlspecialchars(stripslashes(AUTOFILL_PAYPAL)));} ?>"/>
								<p class="help-block"></p>
							</div>
						</div>
						
						<div class="form-group">
							<label ><?php _e('Alipay Donate Address');?></label>
							<div class="controls">
								<input class="form-control" type="text" name="ALIPAY" style="width: 400px;" data-validation-regex-regex="((https?|ftp|news):\/\/)?([a-z]([a-z0-9\-]*[\.。])+([a-z]{2}|aero|arpa|biz|com|coop|edu|gov|info|int|jobs|mil|museum|name|nato|net|org|pro|travel)|(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/[a-z0-9_\-\.~]+)*(\/([a-z0-9_\-\.]*)(\?[a-z0-9+_\-\.%=&]*)?)?(#[a-z][a-z0-9_]*)?" data-validation-regex-message="<?php _e('Not a valid website address'); ?>" value="<?php if(defined("AUTOFILL_ALIPAY")){echo(htmlspecialchars(stripslashes(AUTOFILL_ALIPAY)));} ?>"/>
								<p class="help-block"></p>
							</div>
						</div>
                    </div>
						...
						<div class="form-group">
							<label ><?php _e('External Statistics');?></label>
							<div class="controls">
						...
						<div class="form-group">
							<label ><?php _e('Internal Statistics');?></label>
							<div class="controls">
						...
						<div class="form-group">
							<label ><?php _e('Advertisement');?></label>
							<div class="controls">
						...
						<div class="form-group">
							<label ><?php _e('Emergency Notice');?></label>
							<div class="controls">
...
<?php
		...
		if (!empty($error_text)) {
			...
			echo $error_text;
			echo '<a href="settings.php" onclick="javascript:history.go(-1);return false;">'.__('Back').'</a></h3>';
		} else {
			/* Update Options */
